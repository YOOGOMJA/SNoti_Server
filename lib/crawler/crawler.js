...
let Crawler = (function(Axios , meta, prm){
    ...
    let fn = {
        get : function(meta, opts){
            ...
            if(opts){
                if(opts.type){
                __params.c = opts.type
                }
                if(opts.cate){
                    __params.t = opts.cate
                }
                if(opts.keyword){
                    __params.k = opts.keyword
                }
                if(opts.page){
                    __url += 'page/' + opts.page;
                }
            }
        ...
        fetch : function(response){
            ...
            return new prm(function(resolve, reject){
                ...
                if(rows.length <= 1){ 
                    ...
                    if(!paging_container || paging_container.length <= 0){
                        ...
                        if(paging_container.querySelector('.last a')){
